...
public class RecvDerror {
	...
	public void toRecv() {
		try {
			...
			channel.queueBind(queueName, EXCHANGE_NAME, ROUTE_KEY_ERROR);
	        ...
	        Consumer consumer = new DefaultConsumer(channel) {
	    		...
	    		public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
	    			...
	    			System.out.println("--- RecvD error [x] Received '" + message + "'");
	    			System.out.println("--- RecvD error  [x] Done '");

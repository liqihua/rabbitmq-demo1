...
public class RecvDwarn {
	...
	public void toRecv() {
		try {
			...
			channel.queueBind(queueName, EXCHANGE_NAME, ROUTE_KEY_WARN);
	        ...
	        Consumer consumer = new DefaultConsumer(channel) {
	    		...
	    		public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
	    			...
	    			System.out.println("--- RecvD warn [x] Received '" + message + "'");
	    			System.out.println("--- RecvD warn  [x] Done '");
